...
$DEFAULT_API_URL = $env:REPORTMATE_API_URL ?? "https://reportmate.example.edu"
...
.EXAMPLE
    .\Set-ReportMatePrefs.ps1 -ApiUrl "https://api.reportmate.example.edu" -Passphrase "ECUAD-RM-2025-PROD" -CollectionInterval 7200 -LogLevel "Debug"
