...
[JsonSerializable(typeof(Modules.CimianEvent))]
[JsonSerializable(typeof(Modules.CimianLoopDetails))]
[JsonSerializable(typeof(Modules.CimianPackageAttempt))]
[JsonSerializable(typeof(Modules.CimianSystemRequirements))]
[JsonSerializable(typeof(List<Modules.CimianItem>))]
[JsonSerializable(typeof(List<Modules.CimianSession>))]
[JsonSerializable(typeof(List<Modules.CimianEvent>))]
...
[JsonSerializable(typeof(NetworkQualityData))]
...
// Identity module Windows Hello types (migrated from Security)
[JsonSerializable(typeof(Modules.WindowsHelloInfo))]
[JsonSerializable(typeof(Modules.CredentialProviderInfo))]
[JsonSerializable(typeof(Modules.CredentialProvider))]
[JsonSerializable(typeof(Modules.BiometricServiceInfo))]
[JsonSerializable(typeof(Modules.BiometricDevice))]
[JsonSerializable(typeof(Modules.WindowsHelloPolicyInfo))]
[JsonSerializable(typeof(Modules.WindowsHelloPolicySetting))]
[JsonSerializable(typeof(Modules.NgcKeyStorageInfo))]
[JsonSerializable(typeof(Modules.KeyStorageProvider))]
[JsonSerializable(typeof(Modules.CredentialGuardInfo))]
[JsonSerializable(typeof(Modules.CredentialGuardSetting))]
[JsonSerializable(typeof(Modules.WindowsHelloEvent))]
[JsonSerializable(typeof(Modules.WebAuthNInfo))]
[JsonSerializable(typeof(Modules.WebAuthNSetting))]
[JsonSerializable(typeof(List<Modules.CredentialProvider>))]
[JsonSerializable(typeof(List<Modules.BiometricDevice>))]
[JsonSerializable(typeof(List<Modules.WindowsHelloPolicySetting>))]
[JsonSerializable(typeof(List<Modules.KeyStorageProvider>))]
[JsonSerializable(typeof(List<Modules.CredentialGuardSetting>))]
[JsonSerializable(typeof(List<Modules.WindowsHelloEvent>))]
[JsonSerializable(typeof(List<Modules.WebAuthNSetting>))]
...
public class DeviceDataPayload
{
    ...
    public string Source { get; set; } = "managedreportsrunner.exe";
