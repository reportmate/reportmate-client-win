...
```powershell
& 'C:\Program Files\ReportMate\managedreportsmanagedreportsrunner.exe' install --api-url "https://reportmate.example.edu"
```
...
managedreportsmanagedreportsrunner.exe install --api-url "https://reportmate.example.edu"
